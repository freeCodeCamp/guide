...
In software engineering, behavior-driven development (BDD) is a software development process that emerged from [test-driven development (TDD)](https://guide.freecodecamp.org/agile/test-driven-development).
