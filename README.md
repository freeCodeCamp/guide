...
- [What can I write an article for?](#what-can-i-write-an-article-for?)
...
### How to contribute
You can create a pull request (PR) with a draft article or edits on an existing article in two ways.
...
- Scroll to the bottom of the screen and add a commit message explaining your changes. Then select the "Create a new branch..." option and click "Propose file changes"
...
- Add a remote upstream so git knows where the official freeCodeCamp guides repository is located with the command `git remote add upstream https://github.com/freeCodeCamp/guides.git`
