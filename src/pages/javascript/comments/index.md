...
Programmers use comments to add hints, notes, suggestions, or warnings to their source code. They have no effect on the actual output of the code, but can be very helpful in explaining the intent of what your code is or should be doing.
...
hello();
```
In many code editors, you can comment out a section of JavaScript by highlighting the lines of code you want to comment out, then press `Cmd/Ctrl + /`.
