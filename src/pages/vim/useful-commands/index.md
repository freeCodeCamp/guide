...
- [Vim Adventures](https://vim-adventures.com/) - An online gamed crudely based off of "The Legend Of Zelda", meant to teach the very basics of Vim. It will give you one command at a time and will not allow you to continue until you have passed the "level". The further that you get into the game, the more commands that you learn.
