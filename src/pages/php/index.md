...
To run PHP script, first you need to initiate PHP head, just put <php (wirte some PHP code) ?> in where you want to write php code script. You can even add HTML script in PHP script, for example; ''' <php
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
