...
Linux allows user to change desktop design and themes, add widgets and more. These changes can be made through desktop environments. Different desktop environments have different set of options. 
