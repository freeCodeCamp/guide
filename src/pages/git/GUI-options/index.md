...
Although mostly people prefer to use git as a CLI(Command-line interface) tool but there are plenty of git gui based solutions available which are more user friendly.
