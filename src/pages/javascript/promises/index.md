...
Promise is better alternative for callback hell, it makes the code easier to read.
...
Promise is immutable, Once Promise is resolved or rejected, it will be settled, if any Promise is settled once then it can't resettle again, multiple resolves/rejects will not add any value, it will always refer first resolve/reject and settle the promise.
