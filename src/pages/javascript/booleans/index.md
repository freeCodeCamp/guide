...
title: Boolean
---
Booleans are a primitive data type found in most (all?) computer programming languages. A boolean can be either `true` or `false`, in JavaScript (spelling or wording may vary in other languages). 
