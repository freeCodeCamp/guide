...
*   **Easy to start program**. Javascript can be programmed on any browsers now, open console from browser's Developer Tools, allows us to type code and test the outputs.
