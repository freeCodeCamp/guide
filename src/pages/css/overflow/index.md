...
```
[![Example Image](https://s26.postimg.org/gweu6g5yh/1-vissible.png)](https://postimg.org/image/6z3tddycl/)

### Hidden:
```css
.box-element { overflow: hidden; }
```
[![Example Image](https://s26.postimg.org/l49mf77e1/2-hidden.png)](https://postimg.org/image/9rx0xeyp1/)

### Scroll:
```css
.box-element { overflow: scroll; }
```
[![Example Image](https://s26.postimg.org/d8z30dxrd/3-scroll.png)](https://postimg.org/image/mtipn9n39/)

### Auto:
```css
.box-element { overflow: auto; }
```
[![Example Image](https://s26.postimg.org/z5q7ei0bt/4-autoank.png)](https://postimg.org/image/uju365esl/)
...
[![Example Image](https://s26.postimg.org/ff2kmdfzd/5-_Xand_Y.png)](https://postimg.org/image/4fhdarpk5/)
