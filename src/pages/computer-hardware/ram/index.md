...
<b>RAM</b> stands for <i>random-access memory</i>, alternatively referred to as **main memory**, **primary memory**, or **system memory** is a computer hardware where the data that your computer is currently working on is stored.<br/>
