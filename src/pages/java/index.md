...
The latest version is <a href='http://www.oracle.com/technetwork/java/javase/downloads/jdk9-downloads-3848520.html' target='_blank' rel='nofollow'>Java 1.9</a> or Java 9, which was released in September, 2017 with <a href='https://docs.oracle.com/javase/9/whatsnew/toc.htm' target='_blank' rel='nofollow'>various improvements</a> over the previous version, Java 8\. But for all intents and purposes, we will use Java 8 in this wiki for all tutorials.
