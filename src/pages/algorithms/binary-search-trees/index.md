...
4. The height of a tree is the longest path between the root node and a leaf.
...
Complexity:
The worst case complexity of insert and search operations is BIG O of 'h', that is O(h), where. h is the height of the tree.
