...
Lists can be styled using the list-style-type property. Some examples of the different list styles include cirle, square, and lower-greek. <a href="https://www.w3schools.com/cssref/pr_list-style-type.asp" shape="rect">Learn more about the CSS list-style-type property and the different style type options</a>.
