...
Additionally, GPUs ability to run multiple tasks at the same time makes the technology highly suitable to for machine-learning and deep learning applications.
