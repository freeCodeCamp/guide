...
- When you want to create an array, you have to either tell its size, or assign values to it. Do not do this, if you do the same the compiler will produce a run-time error:
```C
int arr[];
```
