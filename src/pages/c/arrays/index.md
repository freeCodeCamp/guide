...
## Arrays in C
Arrays are containers with a given size. They contain variables of the **same type**.Memory in array is allocated contigously.You can access a variable stored in the array with its *index*.
