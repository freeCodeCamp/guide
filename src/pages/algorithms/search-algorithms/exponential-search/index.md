---
title: Exponential Search / Finger Search
---

## Exponential Search (also known as Finger Search)
Exponential Search searchs for an element in a sorted array by jumping `2^i` elements every iteration where i represents the 
