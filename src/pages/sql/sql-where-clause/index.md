...
The WHERE clause is used to limit the number of rows returned from a single table or multiple tables.

In below example, WHERE clause is used to filter the rows using and, or, like, between and in.
