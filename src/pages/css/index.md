...
CSS allows for developers to control how web pages look by "styling" the HTML structure of My changes all pages simply by adding one CSS style sheet where before you needed to add style to every element on every page. 
