...
The last module is YARN, which basically manages resources of the systems that store the data and run the analysis for the same. These 4 frameworks are the most popular among Hadoop and they are widely used.
