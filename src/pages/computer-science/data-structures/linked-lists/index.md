...
A linked list is made up of nodes. We call every point on this particular garland-like list to be a node. And each of the node points to the next node in this list as well as it's data.
