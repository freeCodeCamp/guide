  ...
  if (noMatch) {
    return $(_reactRouterDom.Route, {
      ...
      component: function component(props) {
        return $(_syncRequires2.default.components[noMatch.componentChunkName], (0, _extends3.default)({}, props, _syncRequires2.default.json[noMatch.jsonName]));
      }
    });
  } else {
    return null;
...
var Root = function Root() {
  return $(AltRouter ? AltRouter : DefaultRouter, null, $(_reactRouterScroll.ScrollContext, { shouldUpdateScroll }, $((0, _reactRouterDom.withRouter)(layout), {
