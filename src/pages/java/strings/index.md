...
The following snippet will make things more clear. The objective is to understand: How many String objects are created?
...
5. A String is immutable, meaning it cannot be changed once it is created. If you add a character to a String, the entire String object is duplicated with the new character included. Read more on immutability [here](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html).
