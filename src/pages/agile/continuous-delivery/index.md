...
The next step would be Continuous Deployment. That's basically the same like Continuous Delivery - the difference is that in the end you cannot decide manually whether something gets deployed to production, but here changes will be deployed automatically.
