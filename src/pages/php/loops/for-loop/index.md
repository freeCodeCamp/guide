...
**Performance issues**
The above code can became slow, because the array size is fetched in every iteration. In order to fix this problem it`s possible to put the array size into a variable: 
```php
