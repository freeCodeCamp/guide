...
Hybrid Application development for android is a breeze, be it for development or production configuration, however i personally find iOS setup, development and deployment a bit tiring.
