...
Web accessibility should also include people who do not have access to internet or a computer.

A prominent guideline for web development was introduced by the [World Wide Web Consortium (W3C)](https://www.w3.org/), the [Web Accessibility Initiative](https://www.w3.org/WAI/). Which is where we get the [WAI-ARIA](https://developer.mozilla.org/en-US/docs/Learn/Accessibility/WAI-ARIA_basics), the Accessible Rich Internet Applications Suite of web standards.
Where WAI tackles the semantics of HTML to more easily navigate the DOM Tree; WAI-ARIA attempts to make web apps, especially those developed with javascript and
