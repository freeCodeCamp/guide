...
* `increment` - Invoked after each iteration through the loop. You can increase/decrease the value of variables here. Be sure the imcrement is working towards the expression value, to avoid an infinite loop.
