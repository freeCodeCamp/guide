...
* **SourceTree Desktop**-SourceTree is another great application for GUI usage of git. It's a great entry-level application and fairly easy to use. You can read more and get the application [here](https://www.sourcetreeapp.com/).
