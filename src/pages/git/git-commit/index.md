...
- you can recall the commited changes at a later date, or revert the project to that version <a href='/git/git-checkout' target='_blank' rel='nofollow'>see Git checkout</a> 
