...
One tool in that toolbox should be accessibility. It is a tool that is ideally one of the very first steps of writing any form of web content. However, this tool is often not well presented in the toolbox of most developers. This could be due to a simple case of not knowing it even exists to extreme cases like not caring about it.
...
Accessibility is a bit of a misleading term sometimes, especially if English is your second language.
