...
*   Installers can be used to install a specific or multiple Ruby versions. There is also an installer for Windows using <a href='https://rubyinstaller.org' target='_blank' rel='nofollow'>RubyInstaller</a>.
