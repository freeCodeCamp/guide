...
Z Index (`z-index`) is a CSS property that lets us define the order of overlapping HTML elements(think of it in layers). Elements with a higher index will be placed on top of elements with a lower index.
