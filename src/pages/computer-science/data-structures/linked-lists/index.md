...
title: Linked Lists
---
A linked list is made up of nodes. We call every point on this particular data structure to be a node. And each of the node points to the next node in this list along with the data stored.
