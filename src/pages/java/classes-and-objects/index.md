...
Classes are groups of variables and operations on them. A class can have variables, methods (or functions) and constructors (special methods which are used on instantiation of a class, more on that later!).
...
Objects are _instances_ of a class. All objects are instances of a certain class. Imagine a class being like the blueprints for a car while an object represents an actual car - you can't drive around in the blueprints, only in the finished car. Now let's look at a code example:
